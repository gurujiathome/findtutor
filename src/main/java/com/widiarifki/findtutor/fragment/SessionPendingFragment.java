...
import com.widiarifki.findtutor.adapter.SessionPendingAdapter;
...
public class SessionPendingFragment extends Fragment {
    ...
    void fetchData(){
        ...
        RequestBody formBody = new FormBody.Builder()
                ...
                .add(Constants.PARAM_KEY_SESSION_STATE, Constants.SESSION_PENDING+"")
                .build();
